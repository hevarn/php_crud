    ...
    <div class="container-userinfo-panel">
        <div class="userinfo-panel__content">
            <div class="menu">
                <div class="menu-user-lateral">
                    <div class="profile-head">
                        <div class="profile-head__id">
                            <img class="user-profile-picture" src="https://creer.casecompany.paris/uploads/themes/original/5c9deb858a91e.png" alt="">
                            <div>
                ...
                <div class="new">
                    <button class="new__button new-mail__toggle"><i> send mail</i></button>
                    <div class="new-mail">
            ...
            <div class="mails">
                ...
                <div class="preview">
                    <div class="preview-top">
                        ...
                        <div class="preview__title">vos bouteilles poster</div>
                        <div>
                        ...
                        <div class="preview-content scrollable__target">
                            <div class="preview-respond">
                                <div class="preview-respond__head">
                                    <div class="profile-head">
                                        <div class="profile-head__id">
                                            <img class="user-profile-picture" src="https://pickaface.net/gallery/avatar/20130510_100741_226_grandpa.png" alt="">
                                            <div>
